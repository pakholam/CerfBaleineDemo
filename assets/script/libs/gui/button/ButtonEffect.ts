...
@menu('IkunFramework/Button/ButtonEffect （有特效按钮）')
export default class ButtonEffect extends ButtonSimple {
    ...
    onLoad() {
        ...
        var ac_start: AnimationClip = ikun.res.get("common/anim/button_scale_start", AnimationClip)!;
        var ac_end: AnimationClip = ikun.res.get("common/anim/button_scale_end", AnimationClip)!;
