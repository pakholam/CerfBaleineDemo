...
/** 
 * 日志管理 
 * @help    https://gitee.com/dgflash/ikun-framework/wikis/pages?sort_id=12037904&doc_id=2873565
 * @example
ikun.log.trace("默认标准日志");
ikun.log.logConfig("灰色配置日志");
ikun.log.logNet("橙色网络日志");
ikun.log.logModel("紫色数据日志");
ikun.log.logBusiness("蓝色业务日志");
ikun.log.logView("绿色视图日志");
 */
export class Logger {
